CC = gcc
SRC = main.c bdd.c gui.c create_user.c login.c compte.c transactions.c bdd_checks.c bdd_updates.c alerts.c
OBJ = main.o bdd.o gui.o create_user.o login.o compte.o transactions.o bdd_checks.o bdd_updates.o alerts.o
